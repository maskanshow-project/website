    ...
    export default {
        ...
        computed : {
            ...
            Breadcrumb() {
                ...
                let areas = []
                if( this.is_exist(this.$route.query.areas) && typeof this.$route.query.areas == 'object' ) {
                ...
                let query = `
                    {
                        estates(
                            ...
                            created_at : "${ this.to_en(this.$route.query.created_at) }" ,
                            areas : [${this.$route.query.areas || ''}] ,
                            ${ this.$route.query.assignments ? `assignment : ${this.$route.query.assignments} ,` : '' }
                            ${ this.$route.query.estate_types ? `estate_type : ${this.$route.query.estate_types} ,` : '' }
