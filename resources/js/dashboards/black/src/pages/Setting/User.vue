<template>
  <div class="row" :style="{ position: 'relative', zIndex: 10 }">
    <div class="row col-12 mb-3">
      <div class="col-12 text-right">
        <div class="pull-right">
          ...
          >
            تنظیمات
            <span :style="{ color: '#ff3d3d' }">حساب</span> کاربری
            <i
          ...
          >با استفاده از این بخش میتوانید اطلاعات حساب خود را مدیریت کرده یا رمز عبور خود را تغییر دهید</h6>
        </div>
    ...
    <card class="text-right animated bounceInBottom delay-last" v-if="is_loaded" dir="rtl">
      <span slot="header">ویرایش اطلاعات کاربری</span>
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-4">
              <md-field :class="getValidationClass('first_name')">
                ...
                <md-input
                  ...
                  :maxlength="$v.first_name.$params.maxLength.max"
                />
          ...
          <div class="row">
            <div class="col-md-6">
              <md-field>
                ...
                <span
                  class="md-error"
                  v-show="!$v.phone_number.required"
                >لطفا شماره تلفن را وارد کنید</span>
              </md-field>
            </div>
            ...
            <div class="col-md-6">
              <md-field>
                ...
                <md-input
                  ...
                  disabled
                  :maxlength="$v.username.$params.maxLength.max"
                />
                <i class="md-icon tim-icons icon-email-85"></i>
            ...
            <div class="col-md-4">
              <base-input label="نمایش اطلاعات">
                ...
                <small
                  ...
                  id="emailHelp"
                  class="form-text text-muted"
                >نمایش اطلاعات شما به عنوان ثبت کننده املاک</small>
              </base-input>
            </div>
          </div>
          ...
          <div class="row d-flex justify-content-center mt-3">
            ...
            >
              ...
              </transition>بروز رسانی اطلاعات کلی
            </base-button>
          </div>
        </div>
      </div>
    ...
    <card
      class="text-right animated bounceInBottom delay-last"
      v-if="is_loaded && office"
      dir="rtl"
    >
      <span slot="header">ویرایش اطلاعات دفتر املاک</span>
      ...
      <div class="row">
        <div class="col-md-6">
          <md-field :class="getValidationClass('name')">
            ...
            <span
              class="md-error"
              v-show="!$v.office.name.required"
            >لطفا نام دفتر املاک را وارد کنید</span>
          </md-field>
        </div>
        ...
        <div class="col-md-6">
          <md-field :class="getValidationClass('username')">
            <label>نام کاربری</label>
            <md-input
              v-model="office.username"
              disabled
              :maxlength="$v.office.username.$params.maxLength.max"
            />
            <i class="md-icon tim-icons icon-badge"></i>
            <span class="md-helper-text">برای مثال : amlak-aseman</span>
            <span
              class="md-error"
              v-show="!$v.office.username.required"
            >لطفا نام کاربری دفتر املاک را وارد کنید</span>
          </md-field>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <md-field :class="getValidationClass('phone_number')">
            ...
            <span
              class="md-error"
              v-show="!$v.office.phone_number.required"
            >لطفا شماره تلفن دفتر املاک را وارد کنید</span>
          </md-field>
        </div>
      </div>
        ...
        <div class="col-md-6">
          <md-field :class="getValidationClass('address')">
            ...
            <md-textarea
              ...
              md-autogrow
              :maxlength="$v.office.address.$params.maxLength.max"
            ></md-textarea>
            <i class="md-icon tim-icons icon-square-pin"></i>
            <span class="md-helper-text">آدرس دفتر املاک</span>
            <span
              class="md-error"
              v-show="!$v.office.address.required"
            >لطفا آدرس دفتر املاک را وارد کنید</span>
          </md-field>
        </div>
        ...
        <div class="col-md-6">
          <md-field :class="getValidationClass('description')">
            ...
            <md-textarea
              ...
              md-autogrow
              :maxlength="$v.office.description.$params.maxLength.max"
            ></md-textarea>
      ...
      <div class="row d-flex justify-content-center mt-3">
        ...
        >
          ...
          </transition>بروز رسانی اطلاعات دفتر املاک
        </base-button>
      </div>
    </card>

    <card class="text-right animated bounceInBottom delay-last" v-if="is_loaded" dir="rtl">
      <span slot="header">بروزرسانی رمز عبور</span>
    ...
    <div class="row mb-3 w-100" v-if="info.can_has_member">
      <div class="col-12 text-right">
        <div class="pull-right">
          ...
          >در ساختار درخت شکل زیر ، میتوانید کلیه افراد زیر مجموعه و شخص نسل بالاتر خود را مشاهده و بررسی کنید</h6>
        </div>
      </div>
    </div>
        ...
        <div class="custom-tree-node data-table-row col-12 pr-3" slot-scope="{ node, data }">
          <div class="pull-left d-flex align-items-center">
            ...
            <div class="pull-right group-info" v-if="data.full_name.trim()">
              <h4
                class="md-list-item-text mb-0"
                :class="{ 'text-danger' : data.full_name === 'خود شما' }"
            ...
            <transition-group name="list" class="operation-cell pull-right">
              ...
              <el-dropdown
                v-if="data.roles.length > 3"
                :key="data.roles.map((c) => c.id).join(',')"
              >
      ...
      axios
        ...
        .then(({ data }) => {
          ...
          this.$swal.fire({
            title: "تغییر کرد",
            text:
              "رمز عبور با موفقیت تغییر کرد ، لطفا دوباره وارد حساب خود شوید",
            icon: "success",
            timer: 2000
          });
      ...
      if (this.type === "user") {
        return {
          ...
          phone_number: this.info.phone_number
            ? persianJs(this.info.phone_number)
                .persianNumber()
                .toString()
            : null,
