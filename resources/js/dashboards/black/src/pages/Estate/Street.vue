  ...
  <datatable
    ...
    <template slot="modal">
      ...
      <base-input label="موقعیت جغرافیایی">
        ...
        <small slot="helperText" id="emailHelp" class="form-text text-muted">با گرفتن و رها کردن نشانگر آبی رنگ موقعیت جغرافیایی خیابان را مشخص کنید</small>
      </base-input>
    </template>
...
export default {
  ...
  computed: {
    ...
    allQuery() {
      return `name coordinates { lat lng } area { id name }`
    }
  },
  mounted() {
