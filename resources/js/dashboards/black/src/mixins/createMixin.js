...
export default {
  methods: {
    ...
    create() {
      if (!this.attr("is_creating")) this.clearForm();
    ...
    handleEdit(index, row) {
      ...
      if (typeof this.afterEdit === "function") this.afterEdit(row);
    ...
    storeInServer(options) {
      ...
      if (!this.attr("is_creating") && this.group !== "setting") {
        ...
        else form.args = `id: ${this.attr("selected").id}, ` + form.args;
      }
      ...
      const query = {
        ...
        variables:
          typeof this.getVariables === "function"
            ? this.getVariables()
            : form.variables
      };
      ...
      axios
        ...
        .catch(error => {
          ...
          if (typeof options.errorResolver === "function")
